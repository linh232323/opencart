...
$_['help_category']       = 'Choose all rooms under selected category.';
$_['help_room']        = 'Choose specific rooms the coupon will apply to. Select no rooms to apply coupon to entire cart.';
