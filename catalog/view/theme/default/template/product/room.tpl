            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-12">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <h2><?php if (isset($room_prices)) { ?>
                                    <?php foreach ($room_prices as $room_price) { ?>
                                    <?php if (!empty($room_price['room_price_value'])){ ?> 
                                    <?php $price_cost = $room_price['room_price_value'];} ?>
                                    <?php } ?>
                                    <?php if(isset($price_cost)) { echo $price_cost;}else{ echo $room_price['room_price_null'];} ?>
                                    <?php $price_cost = ''; ?>
                                    <?php } ?>
                                </h2>
                            </li>
                        ...
                        <div id="room">
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                ...
                                <select name="option[<?php echo $option['room_option_id']; ?>]" id="input-option<?php echo $option['room_option_id']; ?>" class="form-control">
                                    <option value=""><?php echo $text_select; ?></option>
                                    <?php foreach ($option['room_option_value'] as $option_value) { ?>
                                    <option value="<?php echo $option_value['room_option_value_id']; ?>"><?php echo $option_value['name']; ?>
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                ...
                                <div id="input-option<?php echo $option['room_option_id']; ?>">
                                    <?php foreach ($option['room_option_value'] as $option_value) { ?>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="option[<?php echo $option['room_option_id']; ?>]" value="<?php echo $option_value['room_option_value_id']; ?>" />
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                ...
                                <div id="input-option<?php echo $option['room_option_id']; ?>">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="option[<?php echo $option['room_option_id']; ?>][]" value="<?php echo $option_value['room_option_value_id']; ?>" />
                                            <?php echo $option_value['name']; ?>
                                            <?php if ($option_value['price']) { ?>
                                            (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
                                            <?php } ?>
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                <label class="control-label" for="input-option<?php echo $option['room_option_id']; ?>"><?php echo $option['name']; ?></label>
                                <textarea name="option[<?php echo $option['room_option_id']; ?>]" rows="5" placeholder="<?php echo $option['name']; ?>" id="input-option<?php echo $option['room_option_id']; ?>" class="form-control"><?php echo $option['value']; ?></textarea>
                            </div>
                            <?php } ?>
                            <?php if ($option['type'] == 'file') { ?>
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                <label class="control-label"><?php echo $option['name']; ?></label>
                                <button type="button" id="button-upload<?php echo $option['room_option_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default btn-block"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                ...
                                <div class="input-group datetime">
                                    <input type="text" name="option[<?php echo $option['room_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-option<?php echo $option['room_option_id']; ?>" class="form-control" />
                                    <span class="input-group-btn">
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                ...
                                <div class="input-group time">
                                    <input type="text" name="option[<?php echo $option['room_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="HH:mm" id="input-option<?php echo $option['room_option_id']; ?>" class="form-control" />
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                                    </span></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="quantity" value="<?php echo $_SESSION['room']; ?>" size="2" id="input-quantity" class="form-control" />
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="room-thumb transition">
                        ...
                        <div class="button-group">
                            <button type="button" onclick="cart.add('<?php echo $room['room_id']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span> <i class="fa fa-shopping-cart"></i></button>
...
<script type="text/javascript">
    ...
    $.ajax({
    url: 'index.php?route=product/room/getRecurringDescription',
            type: 'post',
            data: $('input[name=\'room_id\'], input[name=\'quantity\'], select[name=\'recurring_id\']'),
            dataType: 'json',
            beforeSend: function() {
...
<script type="text/javascript">
    ...
    url: 'index.php?route=checkout/cart/add',
            type: 'post',
            data: $('#room input[type=\'text\'], #room input[type=\'hidden\'], #room input[type=\'radio\']:checked, #room input[type=\'checkbox\']:checked, #room select,#option input, #room textarea'),
            dataType: 'json',
            beforeSend: function() {
...
<script type="text/javascript">
    ...
    e.preventDefault();
            ...
            $('#review').load('index.php?route=product/room/review&room_id=<?php echo $room_id; ?>');
            $('#button-review').on('click', function() {
    $.ajax({
    url: 'index.php?route=product/room/write&room_id=<?php echo $room_id; ?>',
            type: 'post',
            dataType: 'json',
