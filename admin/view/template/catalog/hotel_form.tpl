            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="hotel-filter" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($hotel_filters as $hotel_filter) { ?>
                    <div id="hotel-filter<?php echo $hotel_filter['filter_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $hotel_filter['name']; ?>
                      <input type="hidden" name="hotel_filter[]" value="<?php echo $hotel_filter['filter_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="hotel-download" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($hotel_downloads as $hotel_download) { ?>
                    <div id="hotel-download<?php echo $hotel_download['download_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $hotel_download['name']; ?>
                      <input type="hidden" name="hotel_download[]" value="<?php echo $hotel_download['download_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="hotel-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($hotel_relateds as $hotel_related) { ?>
                    <div id="hotel-related<?php echo $hotel_related['hotel_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $hotel_related['name']; ?>
                      <input type="hidden" name="hotel_related[]" value="<?php echo $hotel_related['hotel_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
                ...
                <table id="attribute" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                      <td class="text-left" style="width: 40%;"><input type="text" name="hotel_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $hotel_attribute['name']; ?>" placeholder="<?php echo $entry_attribute; ?>" class="form-control" />
                      ...
                      <td class="text-left"><?php foreach ($languages as $language) { ?>
                        <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                          <textarea name="hotel_attribute[<?php echo $attribute_row; ?>][hotel_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="1" placeholder="<?php echo $entry_text; ?>" class="form-control"><?php echo isset($hotel_attribute['hotel_attribute_description'][$language['language_id']]) ? $hotel_attribute['hotel_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
                        </div>
                        <?php } ?></td>
              ...
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="option">
                    <?php $option_row = 0; ?>
                    <?php foreach ($hotel_options as $hotel_option) { ?>
                    <li><a href="#tab-option<?php echo $option_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-option<?php echo $option_row; ?>\']').parent().remove(); $('#tab-option<?php echo $option_row; ?>').remove(); $('#option a:first').tab('show');"></i> <?php echo $hotel_option['name']; ?></a></li>
                    <?php $option_row++; ?>
                    <?php } ?>
                    <li>
                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      <input type="hidden" name="hotel_option[<?php echo $option_row; ?>][hotel_option_id]" value="<?php echo $hotel_option['hotel_option_id']; ?>" />
                      <input type="hidden" name="hotel_option[<?php echo $option_row; ?>][name]" value="<?php echo $hotel_option['name']; ?>" />
                      <input type="hidden" name="hotel_option[<?php echo $option_row; ?>][option_id]" value="<?php echo $hotel_option['option_id']; ?>" />
                      <input type="hidden" name="hotel_option[<?php echo $option_row; ?>][type]" value="<?php echo $hotel_option['type']; ?>" />
                      <div class="form-group">
                      ...
                      <?php if ($hotel_option['type'] == 'text') { ?>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="hotel_option[<?php echo $option_row; ?>][value]" value="<?php echo $hotel_option['value']; ?>" placeholder="<?php echo $entry_option_value; ?>" id="input-value<?php echo $option_row; ?>" class="form-control" />
                        </div>
                      </div>
                      <?php } ?>
                      <?php if ($hotel_option['type'] == 'textarea') { ?>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                        <div class="col-sm-10">
                          <textarea name="hotel_option[<?php echo $option_row; ?>][value]" rows="5" placeholder="<?php echo $entry_option_value; ?>" id="input-value<?php echo $option_row; ?>" class="form-control"><?php echo $hotel_option['value']; ?></textarea>
                        </div>
                      </div>
                      <?php } ?>
                      <?php if ($hotel_option['type'] == 'file') { ?>
                      ...
                      <?php } ?>
                      <?php if ($hotel_option['type'] == 'date') { ?>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                        <div class="col-sm-3">
                          <div class="input-group date">
                            <input type="text" name="hotel_option[<?php echo $option_row; ?>][value]" value="<?php echo $hotel_option['value']; ?>" placeholder="<?php echo $entry_option_value; ?>" data-date-format="YYYY-MM-DD" id="input-value<?php echo $option_row; ?>" class="form-control" />
                            <span class="input-group-btn">
                            <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                            </span></div>
                        </div>
                      ...
                      <?php } ?>
                      <?php if ($hotel_option['type'] == 'time') { ?>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                        <div class="col-sm-10">
                          <div class="input-group time">
                            <input type="text" name="hotel_option[<?php echo $option_row; ?>][value]" value="<?php echo $hotel_option['value']; ?>" placeholder="<?php echo $entry_option_value; ?>" data-date-format="HH:mm" id="input-value<?php echo $option_row; ?>" class="form-control" />
                            <span class="input-group-btn">
                      ...
                      <?php } ?>
                      <?php if ($hotel_option['type'] == 'datetime') { ?>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                        <div class="col-sm-10">
                          <div class="input-group datetime">
                            <input type="text" name="hotel_option[<?php echo $option_row; ?>][value]" value="<?php echo $hotel_option['value']; ?>" placeholder="<?php echo $entry_option_value; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-value<?php echo $option_row; ?>" class="form-control" />
                            <span class="input-group-btn">
                            <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            </span></div>
                        </div>
                      ...
                      <?php } ?>
                      <?php if ($hotel_option['type'] == 'select' || $hotel_option['type'] == 'radio' || $hotel_option['type'] == 'checkbox' || $hotel_option['type'] == 'image') { ?>
                      <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            <?php foreach ($hotel_option['hotel_option_value'] as $hotel_option_value) { ?>
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left"><select name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control">
                                  <?php if (isset($option_values[$hotel_option['option_id']])) { ?>
                                  <?php foreach ($option_values[$hotel_option['option_id']] as $option_value) { ?>
                                  <?php if ($option_value['option_value_id'] == $hotel_option_value['option_value_id']) { ?>
                                ...
                                <input type="hidden" name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][hotel_option_value_id]" value="<?php echo $hotel_option_value['hotel_option_value_id']; ?>" /></td>
                              <td class="text-right"><input type="text" name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][quantity]" value="<?php echo $hotel_option_value['quantity']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>
                              <td class="text-left"><select name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][subtract]" class="form-control">
                                  <?php if ($hotel_option_value['subtract']) { ?>
                                  <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                                  <option value="0"><?php echo $text_no; ?></option>
                                  <?php } else { ?>
                                  <option value="1"><?php echo $text_yes; ?></option>
                              ...
                              <td class="text-right"><select name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][price_prefix]" class="form-control">
                                  <?php if ($hotel_option_value['price_prefix'] == '+') { ?>
                                ...
                                <input type="text" name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][price]" value="<?php echo $hotel_option_value['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
                              <td class="text-right"><select name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][points_prefix]" class="form-control">
                                  <?php if ($hotel_option_value['points_prefix'] == '+') { ?>
                                  <option value="+" selected="selected">+</option>
                                  <?php } else { ?>
                                  <option value="+">+</option>
                                  <?php } ?>
                                ...
                                <input type="text" name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][points]" value="<?php echo $hotel_option_value['points']; ?>" placeholder="<?php echo $entry_points; ?>" class="form-control" /></td>
                              <td class="text-right"><select name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][weight_prefix]" class="form-control">
                                  <?php if ($hotel_option_value['weight_prefix'] == '+') { ?>
                                  <option value="+" selected="selected">+</option>
                                  <?php } else { ?>
                                  <option value="+">+</option>
                                  <?php } ?>
                                ...
                                <input type="text" name="hotel_option[<?php echo $option_row; ?>][hotel_option_value][<?php echo $option_value_row; ?>][weight]" value="<?php echo $hotel_option_value['weight']; ?>" placeholder="<?php echo $entry_weight; ?>" class="form-control" /></td>
            ...
            <div class="tab-pane" id="tab-recurring">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <?php $recurring_row = 0; ?>
                    <?php foreach ($hotel_recurrings as $hotel_recurring) { ?>
                    
                    <tr id="recurring-row<?php echo $recurring_row; ?>">
                      <td class="text-left"><select name="hotel_recurrings[<?php echo $recurring_row; ?>][recurring_id]" class="form-control">
                          <?php foreach ($recurrings as $recurring) { ?>
                          <?php if ($recurring['recurring_id'] == $hotel_recurring['recurring_id']) { ?>
                      ...
                      <td class="text-left"><select name="hotel_recurrings[<?php echo $recurring_row; ?>][customer_group_id]" class="form-control">
                          <?php foreach ($customer_groups as $customer_group) { ?>
                          <?php if ($customer_group['customer_group_id'] == $hotel_recurring['customer_group_id']) { ?>
            ...
            <div class="tab-pane" id="tab-discount">
              <div class="table-responsive">
                <table id="discount" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <?php $discount_row = 0; ?>
                    <?php foreach ($hotel_discounts as $hotel_discount) { ?>
                    <tr id="discount-row<?php echo $discount_row; ?>">
                      <td class="text-left"><select name="hotel_discount[<?php echo $discount_row; ?>][customer_group_id]" class="form-control">
                          <?php foreach ($customer_groups as $customer_group) { ?>
                          <?php if ($customer_group['customer_group_id'] == $hotel_discount['customer_group_id']) { ?>
                          <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                          <?php } ?>
                      ...
                      <td class="text-right"><input type="text" name="hotel_discount[<?php echo $discount_row; ?>][quantity]" value="<?php echo $hotel_discount['quantity']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="hotel_discount[<?php echo $discount_row; ?>][priority]" value="<?php echo $hotel_discount['priority']; ?>" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="hotel_discount[<?php echo $discount_row; ?>][price]" value="<?php echo $hotel_discount['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
                          <input type="text" name="hotel_discount[<?php echo $discount_row; ?>][date_start]" value="<?php echo $hotel_discount['date_start']; ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
                          <input type="text" name="hotel_discount[<?php echo $discount_row; ?>][date_end]" value="<?php echo $hotel_discount['date_end']; ?>" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
            ...
            <div class="tab-pane" id="tab-special">
              <div class="table-responsive">
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <?php $special_row = 0; ?>
                    <?php foreach ($hotel_specials as $hotel_special) { ?>
                    <tr id="special-row<?php echo $special_row; ?>">
                      <td class="text-left"><select name="hotel_special[<?php echo $special_row; ?>][customer_group_id]" class="form-control">
                          <?php foreach ($customer_groups as $customer_group) { ?>
                          <?php if ($customer_group['customer_group_id'] == $hotel_special['customer_group_id']) { ?>
                          <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                          <?php } ?>
                      ...
                      <td class="text-right"><input type="text" name="hotel_special[<?php echo $special_row; ?>][priority]" value="<?php echo $hotel_special['priority']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="hotel_special[<?php echo $special_row; ?>][price]" value="<?php echo $hotel_special['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
                          <input type="text" name="hotel_special[<?php echo $special_row; ?>][date_start]" value="<?php echo $hotel_special['date_start']; ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
                          <input type="text" name="hotel_special[<?php echo $special_row; ?>][date_end]" value="<?php echo $hotel_special['date_end']; ?>" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right"><input type="text" name="hotel_reward[<?php echo $customer_group['customer_group_id']; ?>][points]" value="<?php echo isset($hotel_reward[$customer_group['customer_group_id']]) ? $hotel_reward[$customer_group['customer_group_id']]['points'] : ''; ?>" class="form-control" /></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left"><select name="hotel_layout[0]" class="form-control">
                          ...
                          <?php if (isset($hotel_layout[0]) && $hotel_layout[0] == $layout['layout_id']) { ?>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><select name="hotel_layout[<?php echo $store['store_id']; ?>]" class="form-control">
                          <option value=""></option>
                          <?php foreach ($layouts as $layout) { ?>
                          <?php if (isset($hotel_layout[$store['store_id']]) && $hotel_layout[$store['store_id']] == $layout['layout_id']) { ?>
                          <option value="<?php echo $layout['layout_id']; ?>" selected="selected"><?php echo $layout['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>
                          <?php } ?>
...
function addAttribute() {
	...
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><textarea name="hotel_attribute[' + attribute_row + '][hotel_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="1" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
    <?php } ?>
	html += '  </td>';
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		html += '	<input type="hidden" name="hotel_option[' + option_row + '][hotel_option_id]" value="" />';
		html += '	<input type="hidden" name="hotel_option[' + option_row + '][name]" value="' + item['label'] + '" />';
		html += '	<input type="hidden" name="hotel_option[' + option_row + '][option_id]" value="' + item['value'] + '" />';
		html += '	<input type="hidden" name="hotel_option[' + option_row + '][type]" value="' + item['type'] + '" />';
		
		html += '	<div class="form-group">';
		html += '	  <label class="col-sm-2 control-label" for="input-required' + option_row + '"><?php echo $entry_required; ?></label>';
		html += '	  <div class="col-sm-10"><select name="hotel_option[' + option_row + '][required]" id="input-required' + option_row + '" class="form-control">';
		...
		if (item['type'] == 'text') {
			...
			html += '	  <div class="col-sm-10"><input type="text" name="hotel_option[' + option_row + '][value]" value="" placeholder="<?php echo $entry_option_value; ?>" id="input-value' + option_row + '" class="form-control" /></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'textarea') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><textarea name="hotel_option[' + option_row + '][value]" rows="5" placeholder="<?php echo $entry_option_value; ?>" id="input-value' + option_row + '" class="form-control"></textarea></div>';
			html += '	</div>';			
		}
		...
		if (item['type'] == 'date') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-3"><div class="input-group date"><input type="text" name="hotel_option[' + option_row + '][value]" value="" placeholder="<?php echo $entry_option_value; ?>" data-date-format="YYYY-MM-DD" id="input-value' + option_row + '" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'time') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><div class="input-group time"><input type="text" name="hotel_option[' + option_row + '][value]" value="" placeholder="<?php echo $entry_option_value; ?>" data-date-format="HH:mm" id="input-value' + option_row + '" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'datetime') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><div class="input-group datetime"><input type="text" name="hotel_option[' + option_row + '][value]" value="" placeholder="<?php echo $entry_option_value; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-value' + option_row + '" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></div>';
			html += '	</div>';
		}
...
function addDiscount() {
    ...
    html += '  <td class="text-left"><div class="input-group date"><input type="text" name="hotel_discount[' + discount_row + '][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
	html += '  <td class="text-left"><div class="input-group date"><input type="text" name="hotel_discount[' + discount_row + '][date_end]" value="" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
...
function addSpecial() {
    ...
    html += '  <td class="text-left"><select name="hotel_special[' + special_row + '][customer_group_id]" class="form-control">';
    <?php foreach ($customer_groups as $customer_group) { ?>
    html += '      <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo addslashes($customer_group['name']); ?></option>';
    <?php } ?>
    html += '  </select></td>';		
    html += '  <td class="text-right"><input type="text" name="hotel_special[' + special_row + '][priority]" value="" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>';
	html += '  <td class="text-right"><input type="text" name="hotel_special[' + special_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>';
    html += '  <td class="text-left" style="width: 20%;"><div class="input-group date"><input type="text" name="hotel_special[' + special_row + '][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
	html += '  <td class="text-left" style="width: 20%;"><div class="input-group date"><input type="text" name="hotel_special[' + special_row + '][date_end]" value="" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
...
function addRecurring() {
	...
	html += '  <td class="left">';
	html += '    <select name="hotel_recurrings[' + recurring_row + '][recurring_id]" class="form-control">>';
	<?php foreach ($recurrings as $recurring) { ?>
	...
	html += '  </td>';
	html += '  <td class="left">';
	html += '    <select name="hotel_recurrings[' + recurring_row + '][customer_group_id]" class="form-control">>';
	<?php foreach ($customer_groups as $customer_group) { ?>
