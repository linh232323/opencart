...
$_['entry_proparent_limit'] 	           = 'Default Items Per Page (Catalog)';
$_['entry_proparent_description_length'] = 'List Description Limit (Catalog)';
...
$_['entry_image_proparent']            = 'Proparent Image List Size';
...
$_['help_proparent_limit'] 	           = 'Determines how many catalog items are shown per page (proparents, categories, etc)';
$_['help_proparent_description_length']  = 'In the list view, short description character limit (categories, special etc)';
...
$_['error_image_proparent']            = 'Proparent List Size dimensions required!';
