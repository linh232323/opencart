  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="submit" form="form-hotel" formaction="<?php echo $copy; ?>" data-toggle="tooltip" title="<?php echo $button_copy; ?>" class="btn btn-default"><i class="fa fa-copy"></i></button>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-hotel').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-hotel">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($hotel['hotel_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($hotel['image']) { ?>
                    <img src="<?php echo $hotel['image']; ?>" alt="<?php echo $hotel['name']; ?>" class="img-thumbnail" />
                    <?php } else { ?>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=catalog/hotel&token=<?php echo $token; ?>';
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/hotel/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
