<?php
// Heading
$_['heading_title']          = 'Khách sạn'; 

// Text  
$_['text_success']      = 'Thành công: Khách sạn đã được thay đổi!';
$_['text_plus']              = '+';
$_['text_minus']             = '-';
...
$_['entry_stock_status']     = 'Hết hàng:<br/><span class="help">Tình trạng hiện ra khi một khách sạn hết hàng</span>';
$_['entry_price']            = 'Giá:';
$_['entry_tax_class']        = 'Loại Thuế:';
$_['entry_points']           = 'Điểm:<br/><span class="help">Số điểm cần thiết để mua mặt hàng này. Nếu bạn không \'muốn khách sạn này được mua với điểm để là 0.</span>';
...
$_['entry_related']          = 'Khách sạn cùng loại:';
...
$_['error_permission']       = 'Cảnh báo: Bạn không được phép thay đổi các khách sạn!';
$_['error_name']             = 'Tên khách sạn phải lớn hơn 3 và nhỏ hơn 255 ký tự!';
$_['error_model']            = 'Model khách sạn phải lớn hơn 3 và nhỏ hơn 64 ký tự!';
?>