          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-room"><?php echo $entry_hotel; ?></label>
                <input type="text" name="filter_hotel" value="<?php echo $filter_hotel; ?>" placeholder="<?php echo $entry_hotel; ?>" id="input-room" class="form-control" />
              </div>
              <div class="form-group">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    <a href="<?php echo $sort_hotel; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_hotel; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_hotel; ?>"><?php echo $column_hotel; ?></a>
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
	...
	if (filter_hotel) {
		url += '&filter_hotel=' + encodeURIComponent(filter_hotel);
	}
