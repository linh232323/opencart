...
$_['entry_room_limit']              = 'Default Items Per Page (Catalog)';
$_['entry_room_description_length'] = 'List Description Limit (Catalog)';
$_['entry_limit_admin']                = 'Default Items Per Page (Admin)';
$_['entry_room_count']              = 'Category Room Count';
...
$_['entry_image_thumb']                = 'Room Image Thumb Size';
$_['entry_image_popup']                = 'Room Image Popup Size';
$_['entry_image_room']              = 'Room Image List Size';
$_['entry_image_additional']           = 'Additional Room Image Size';
$_['entry_image_related']              = 'Related Room Image Size';
...
$_['help_room_limit'] 	           = 'Determines how many catalog items are shown per page (rooms, categories, etc).';
$_['help_room_description_length']  = 'In the list view, short description character limit (categories, special etc).';
$_['help_limit_admin']   	           = 'Determines how many admin items are shown per page (orders, customers, etc).';
$_['help_room_count']               = 'Show the number of rooms inside the subcategories in the storefront header category menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!';
...
$_['help_checkout_guest']              = 'Allow customers to checkout without creating an account. This will not be available when a downloadable room is in the shopping cart.';
...
$_['help_complete_status']             = 'Set the order status the customer\'s order must reach before they are allowed to access their downloadable rooms and gift vouchers.';
$_['help_order_mail']                  = 'Send an email to the store owner when a new order is created.';
$_['help_stock_display']               = 'Display stock quantity on the room page.';
$_['help_stock_warning']               = 'Display out of stock message on the shopping cart page if a room is out of stock but stock checkout is yes. (Warning always shows if stock checkout is no)';
$_['help_stock_checkout']              = 'Allow customers to still checkout if the rooms they are ordering are not in stock.';
...
$_['error_image_thumb']                = 'Room Image Thumb Size dimensions required!';
$_['error_image_popup']                = 'Room Image Popup Size dimensions required!';
$_['error_image_room']              = 'Room List Size dimensions required!';
$_['error_image_category']             = 'Category List Size dimensions required!';
$_['error_image_additional']           = 'Additional Room Image Size dimensions required!';
$_['error_image_related']              = 'Related Room Image Size dimensions required!';
