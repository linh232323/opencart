    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-product"><span data-toggle="tooltip" title="<?php echo $help_proparent; ?>"><?php echo $entry_proparent; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="proparent" value="<?php echo $proparent; ?>" placeholder="<?php echo $entry_proparent; ?>" id="input-product" class="form-control" />
              <input type="hidden" name="proparent_id" value="<?php echo $proparent_id; ?>" />
              <?php if ($error_proparent) { ?>
              <div class="text-danger"><?php echo $error_proparent; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
...
$('input[name=\'proparent\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'proparent\']').val(item['label']);
		$('input[name=\'proparent_id\']').val(item['value']);		
	}	
});
//--></script></div>
<?php echo $footer; ?>