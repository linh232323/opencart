    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-room"><span data-toggle="tooltip" title="<?php echo $help_hotel; ?>"><?php echo $entry_hotel; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="hotel" value="<?php echo $hotel; ?>" placeholder="<?php echo $entry_hotel; ?>" id="input-room" class="form-control" />
              <input type="hidden" name="hotel_id" value="<?php echo $hotel_id; ?>" />
              <?php if ($error_hotel) { ?>
              <div class="text-danger"><?php echo $error_hotel; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
...
$('input[name=\'hotel\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'hotel\']').val(item['label']);
		$('input[name=\'hotel_id\']').val(item['value']);		
	}	
});
//--></script></div>
<?php echo $footer; ?>