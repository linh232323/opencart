...
// Text
$_['text_sync_import_line1']            = '<strong>Caution!</strong> This will import all of your eBay rooms and build a category structure in your store. It is advised that you delete all categories and rooms before you run this option. <br />The category structure is from the normal eBay categories, not your shop categories (if you have an eBay shop). You can rename, remove and edit the imported categories without affecting your eBay rooms.';
...
$_['text_import_confirm']				= 'This will import all of your eBay items as new rooms, are you sure? This CAN NOT be undone! ENSURE you have a backup first!';
