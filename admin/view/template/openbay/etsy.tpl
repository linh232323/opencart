...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-3 text-center">
        <div class="well"> <a href="<?php echo $links_rooms; ?>"> <span class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i> <i class="fa fa-link fa-stack-1x"></i> </span>
          <h4><?php echo $text_heading_rooms; ?></h4>
          </a> </div>
      </div>
      <div class="col-md-3 text-center">
