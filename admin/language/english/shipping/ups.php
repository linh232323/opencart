...
$_['help_origin']                  = 'What origin point should be used (this setting affects only what UPS room names are shown to the user)';
...
$_['help_insurance']               = 'Enables insurance with room total as the value';
