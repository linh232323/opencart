...
$_['entry_hotel_limit'] 	           = 'Default Items Per Page (Catalog)';
$_['entry_hotel_description_length'] = 'List Description Limit (Catalog)';
...
$_['entry_image_hotel']            = 'hotel Image List Size';
...
$_['help_hotel_limit'] 	           = 'Determines how many catalog items are shown per page (hotels, categories, etc)';
$_['help_hotel_description_length']  = 'In the list view, short description character limit (categories, special etc)';
...
$_['error_image_hotel']            = 'hotel List Size dimensions required!';
