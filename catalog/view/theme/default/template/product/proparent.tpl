            ...
            <div id="content" class="col-lg-12"><?php echo $content_top; ?>
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xs-12">
                        ...
                        <div class="row"> 
                            <div class="product-layout product-list col-lg-12" id="product-layout">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-lg-3 col-xs-3">
                                                <div class="center-block">
                                                    <a href="<?php echo $product['href'];?>"><button type="button" class="btn btn-primary btn-block btn-blue center-block"><i class="fa fa-shopping-cart"></i> <strong><?php echo $text_book; ?></strong></button></a>
                                                </div>
                                                <p class = "text-center" >
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="proparent-thumb transition">
                            ...
                            <div class="caption">
                                ...
                                <p class="col-lg-12"><?php echo $proparent['description']; ?></p>
